#!/usr/bin/env python3
# deep_nn_app.py - Deep Neural Network for Image Classification: Application
...
train_x_flatten = train_x_orig.reshape(train_x_orig.shape[0], -1).T # (num_px*num_px*3, m_train)
test_x_flatten = test_x_orig.reshape(test_x_orig.shape[0], -1).T # (num_px*num_px*3, m_test)
...
if __name__ == '__main__':
	# # Let run the 2-layer NN model.
	# parameters = two_layer_model(train_x, train_y, layers_dims = (n_x, n_h, n_y), num_iterations = 2500, print_cost=True)
	# # Now, you can use the trained parameters to classify images from the dataset.
	# # To see your predictions on the training and test sets.
	# predictions_train = predict(train_x, train_y, parameters)
	# predictions_test = predict(test_x, test_y, parameters)

	# Let run the L-layer deep NN model.
	parameters = L_layer_model(train_x, train_y, layers_dims, num_iterations = 2500, print_cost = True)
	# Predictions on the traning and test sets.
