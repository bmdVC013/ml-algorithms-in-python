#!/usr/bin/env python3
# building_deep_nn.py - Build a deep neural network, with as many layers as you want!
...
def compute_cost(AL, Y):
	...
	cost = float(-1/m) * np.sum(Y*np.log(AL) + (1-Y)*np.log(1-AL))

	cost = np.squeeze(cost) # [[17]] -> array(15)
	assert (cost.shape == ())
